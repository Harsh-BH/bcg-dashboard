  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "flex w-fit items-center justify-between gap-1.5 rounded-lg border border-input bg-transparent py-2 pr-2 pl-3 text-sm whitespace-nowrap",
        ...
        // size variants — h-9 default, h-8 sm
    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(
            "relative isolate z-[200] max-h-(--available-height) w-(--anchor-width) min-w-40",
            "origin-(--transform-origin) overflow-x-hidden overflow-y-auto",
            "rounded-xl bg-white text-slate-800",
            "shadow-xl ring-1 ring-slate-200 border border-slate-200",
            "duration-150",
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "rounded-md py-1.5 pr-8 pl-2.5 text-sm",
